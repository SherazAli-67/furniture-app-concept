...
class BestSellerProductItemWidget extends StatelessWidget{
  const BestSellerProductItemWidget({super.key, required this.product});
              ...
              child: Stack(
                children: [
                  Padding(
                      ...
                      child: Hero(
                          tag: product.id,
                          child: Image.asset(product.productImg, height: 100,width: 90,))),
